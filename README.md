...
To learn more about the product, email -> tor@ace-high.com
or visit www.ace-high.com

## Introduction
The Ranger module enables smart distributed actuators for applications that require mechanical motion.
Building on engineering experience from the space industry, the Ranger targets industrial, robotics and aerospace applications. If you're in the search for a reliable actuator controll solution - Ranger is just what you need.
